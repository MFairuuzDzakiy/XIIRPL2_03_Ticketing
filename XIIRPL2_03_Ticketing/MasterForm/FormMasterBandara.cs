...
namespace XIIRPL2_03_Ticketing.MasterForm
{
    public partial class FormMasterBandara : Form
    {
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            {
                koneksi.conn.Open();
                String sql = "INSERT INTO tbl_bandara" + "(nama,kode_iata,kota,negara_id,jumlah_terminal,alamat)" + "VALUES" + "('" + txtNama.Text + "','" + txtIATA.Text + "'," + "'" + txtKota.Text + "','" + txtNegara.Text + "'," + "'" + txtJmlTerminal.Text + "','" + txtAlamat.Text + "')";
